...
<?php require_once('assets/plugins/getid3/getid3.php'); ?>
	...
	if(isset($_POST['submit'])) {
        ...
        if ($_POST['upload_type'] == 'url') {
            ...
            if ($imageFormat == 'mp4') {
                ...
                if (file_put_contents($filename, file_get_contents($imageUrl, false, null, 0, 300000))) {
            ...
            if ($_FILES['wallpaper_image']['name'] != '') {
                ...
                if ($imageFormat == 'mp4') {
                    ...
                    $thumbnail_image = new Thumbnail($filePath, 300, 600, 25);
                    $thumbnail_image->save("upload/thumbs/".$wallpaperImage);
