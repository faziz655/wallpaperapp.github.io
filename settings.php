                        	...
                        	<div class="row clearfix">
                                ...
                                <div class="col-sm-12">
                                    <div class="alert alert-info alert-dismissible corner-radius bottom-offset">
                                        ...
                                        <a href="apps.php"><button type="button" class="button button-rounded waves-effect" style="margin-top: 10px; background: #ffffff; color: #555555;">OPEN APPS MENU</button></a>
                                    </div>
                                </div>
