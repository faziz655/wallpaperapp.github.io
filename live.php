										...
										<td style="vertical-align: middle;">
											<?php if ($data['type'] == 'url') { ?>
												<?php if ($data['image_extension'] == 'application/octet-stream') { ?>
													<a href="" data-toggle="modal" data-target="#modal_preview<?php echo $data['id']; ?>"><img class="<?php if ($data['image_status'] == '1') { echo 'img-rounded';} else {echo 'img-rounded img-grayscale';} ?>" src="upload/thumbs/<?php echo $data['image_thumb'];?>" height="64px" width="40px"/></a>
												<?php } else { ?>
													<img class="<?php if ($data['image_status'] == '1') { echo 'img-rounded';} else {echo 'img-rounded img-grayscale';} ?>" src="<?php echo $data['image_url'];?>" height="64px" width="40px"/>
												<?php } ?>
											<?php } else { ?>
												<?php if ($data['image_extension'] == 'application/octet-stream') { ?>
													<a href="" data-toggle="modal" data-target="#modal_preview<?php echo $data['id']; ?>"><img class="<?php if ($data['image_status'] == '1') { echo 'img-rounded';} else {echo 'img-rounded img-grayscale';} ?>" src="upload/thumbs/<?php echo $data['image_thumb'];?>" height="64px" width="40px"/></a>
												<?php } else { ?>
													<img class="<?php if ($data['image_status'] == '1') { echo 'img-rounded';} else {echo 'img-rounded img-grayscale';} ?>" src="upload/<?php echo $data['image'];?>" height="64px" width="40px"/>
												<?php } ?>
											<?php } ?>
										</td>
